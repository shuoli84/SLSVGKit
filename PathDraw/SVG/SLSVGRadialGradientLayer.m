...
@implementation SLSVGRadialGradientLayer {
...
-(void)drawInContext:(CGContextRef)ctx {
    ...
    CGContextDrawRadialGradient(ctx, gradient, self.focal, 0.f, self.center, self.r, kCGGradientDrawsAfterEndLocation | kCGGradientDrawsBeforeStartLocation);
